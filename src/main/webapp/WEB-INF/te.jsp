        ...
        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-sm-offset-4 login-box">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="account-login">
                    <form id="normal_form" name="form" role="form" class="login-form" action="${ctx}/user/normalLogin"
                          method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="4" id="code" name="code" class="form-control" placeholder="验证码"
                                   onblur="checkCode()">
                        </div>
...
<script>
    $('input').blur(function () {
        if (this.style.borderColor = this.value == '' ? 'red':'blue');
            });
